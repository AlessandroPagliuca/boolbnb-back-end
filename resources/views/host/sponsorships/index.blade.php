                        ...
                        <div class="card bg-dark-card text-white my-5 mx-0 mx-sm-5 mx-lg-0 d-flex flex-column">
                            <div class="border-bottom">
                                <div class="m-auto d-flex align-content-center flex-column justify-content-center p-5">
                                    ...
                                    <p class=" fs-small text-uppercase fit-content m-0 m-auto border border-3 border-white px-2">
                                        {{ $sponsor->name }}</p>
                                </div>
                            </div>
                            ...
                            <div class="border-top text-center py-4 px-5">
                                ...
                                <p class=" fs-5 fw-semibold">@if ($sponsor->name == 'Premium')
                            ...
                            @endif{{$sponsor->price}}&euro;</p>
                                <a class=" text-white text-decoration-none" href="#"><button class="btn btn-success text-uppercase fw-semibold">sponsor for {{$sponsor->price}}&euro;</button></a>
                            </div>
                        </div>
                    </div>
                @endforeach
